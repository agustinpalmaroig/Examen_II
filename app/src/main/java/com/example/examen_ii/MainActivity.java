...
public class MainActivity extends AppCompatActivity {
    ...
    protected String doInBackground(String... strings) { for(int i = 1; i < 10; i++)
    {
        try {
    ...
    protected void onPostExecute(String s) {
        ...
        progress.setVisibility(View.INVISIBLE); Intent i = new Intent(getBaseContext(), Menu_act.class);
        startActivity(i); }
    }
}